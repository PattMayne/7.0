...
<article class="article clearfix" id="article_body">
    ...
    <img src="posts/img/puerh-2008-1.png" alt="Descriptive Alt Text" style="float: left; width: 40%; margin-right: 10px;" />
	<p>
    ...
    <img src="posts/img/puerh-2008-2.png" alt="Descriptive Alt Text" style="float: right; width: 30%; margin-left: 10px;" />
	<p>
